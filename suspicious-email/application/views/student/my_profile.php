            ...
            <div class="row">
                <div id="course-left-sidebar" class="col-md-3">
                    ...
                    <div class="course-meta">
                        <p>AMANDA FOX</p>
                        <hr>
                        <p>My Profile <small><a href="my-profile.php">Edit</a></small></p>
                        <hr>
                        <p>My Courses <small class="label label-primary">12</small></p>
                        <hr>
                        <p>Completed Quiz <small class="label label-primary">40</small></p>
                        <hr>
                        <p>Achievements <small class="label label-primary"><a href="course-achievements.php">5</a></small></p>
                        <hr>
            ...
            <div id="owl-featured" class="owl-custom">
                <div class="owl-featured">
                    <div class="shop-item-list entry">
                        ...
                        <div class="shop-item-title clearfix">
                            <h4><a href="course-single.php">Learn Web Design & Development</a></h4>
                            <div class="shopmeta">
                        ...
                        <div class="visible-buttons">
                            <a title="Add to Cart" href="page-shop-cart.php"><span class="fa fa-cart-arrow-down"></span></a>
                            <a title="Read More" href="course-single.php"><span class="fa fa-search"></span></a>
                        </div>
                    </div>
                </div>
                <div class="owl-featured">
                    <div class="shop-item-list entry">
                        ...
                        <div class="shop-item-title clearfix">
                            <h4><a href="course-single.php">Graphic Design & Logo Mockups Course</a></h4>
                            <div class="shopmeta">
                ...
                <div class="owl-featured">
                    <div class="shop-item-list entry">
                        ...
                        <div class="shop-item-title clearfix">
                            <h4><a href="course-single.php">Social Media Network & Marketing</a></h4>
                            <div class="shopmeta">
                ...
                <div class="owl-featured">
                    <div class="shop-item-list entry">
                        ...
                        <div class="shop-item-title clearfix">
                            <h4><a href="course-single.php">WordPress Blogging, Tumblr and Blogger</a></h4>
                            <div class="shopmeta">
                                <span class="pull-left">98 Student</span>
                                <div class="rating pull-right">
                                    <i class="fa fa-star"></i>
                ...
                <div class="col-md-3 col-md-6 col-xs-12">
                    <div class="widget">
                        ...
                        <ul class="popular-courses">
                            <li>
                                <a href="single-course.php" title=""><img class="img-thumbnail" src="upload/xservice_01.png.pagespeed.ic.2iuJZT3CaV.png" alt=""></a>
                            </li>
                            <li>
                                <a href="single-course.php" title=""><img class="img-thumbnail" src="upload/xservice_02.png.pagespeed.ic.c6RThoxSWC.png" alt=""></a>
                            </li>
                            <li>
                                <a href="single-course.php" title=""><img class="img-thumbnail" src="upload/xservice_03.png.pagespeed.ic.E_Ew4wn4ZP.png" alt=""></a>
                            </li>
                            <li>
                                <a href="single-course.php" title=""><img class="img-thumbnail" src="upload/xservice_04.png.pagespeed.ic.NGi9jRXTXk.png" alt=""></a>
                            </li>
                            <li>
                                <a href="single-course.php" title=""><img class="img-thumbnail" src="upload/xservice_05.png.pagespeed.ic.2iuJZT3CaV.png" alt=""></a>
                            </li>
                            <li>
                                <a href="single-course.php" title=""><img class="img-thumbnail" src="upload/xservice_06.png.pagespeed.ic.o2Uniwq-y5.png" alt=""></a>
                            </li>
                            <li>
                                <a href="single-course.php" title=""><img class="img-thumbnail" src="upload/xservice_07.png.pagespeed.ic.H-fRTeeP8u.png" alt=""></a>
                            </li>
                            <li>
                                <a href="single-course.php" title=""><img class="img-thumbnail" src="upload/xservice_08.png.pagespeed.ic.76ek5JLaEY.png" alt=""></a>
                            </li>
                            <li>
                                <a href="single-course.php" title=""><img class="img-thumbnail" src="upload/xservice_09.png.pagespeed.ic.FJcG938KC-.png" alt=""></a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<!-- Mirrored from templatevisual.com/demo/learnplus/my-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Jun 2018 15:49:18 GMT -->
</php>